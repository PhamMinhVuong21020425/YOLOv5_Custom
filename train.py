...
from utils.torch_utils import EarlyStopping, ModelEMA, select_device, intersect_dicts, torch_distributed_zero_first, de_parallel
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    scaler = torch.GradScaler(device=device.type)  # initialize grad scaler
